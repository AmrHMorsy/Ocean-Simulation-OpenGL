...
{
    light = new Light(window_) ;
    shadow = new Shadow( window, light->get_projection(), light->get_view() ) ;
    camera = new Camera() ;
    ocean = new Ocean( camera->get_view(), camera->get_projection(), camera->get_camera_position(), camera->get_camera_front(), camera->get_fov(),bar, light->get_projection(), light->get_view()) ;
    boat = new Boat( camera->get_view(), camera->get_projection(), camera->get_camera_position(), camera->get_camera_front(), camera->get_fov(),bar, light->get_projection(), light->get_view()) ;
...
{
    shadow->render() ;
    ocean->render(shadow->get_shader_program()) ;
    boat->shade(shadow->get_shader_program()) ;
    shadow->reset() ;
}
...
void Renderer::update_view()
{
    ...
    boat->update_view( camera->get_camera_position(), camera->get_view(), camera->get_camera_front()) ;
