...
Waves::Waves(): N(64), L(128), gravity(9.81f), wind_speed(100.0f), phillips_constant(1.0f), wind_direction(glm::normalize(glm::vec2(1.0f,1.0f))), fourier_grid(N*N), fourier_amplitudes(N*N), wavevectors(N*N), fourier_constant( (1.0f / std::sqrt(2.0f)) ), dampening_constant(1.0f)
{
    create_texture() ;
