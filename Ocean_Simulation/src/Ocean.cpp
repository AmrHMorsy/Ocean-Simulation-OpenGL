...
Ocean::Ocean( glm::mat4 v, glm::mat4 proj, glm::vec3 c, glm::vec3 front, float fv, progressbar * b ): num_progress_bars(40),light_position({0.484394f, 7.5f, 0.416144f}), light_color({100.0f, 100.0f, 100.0f}), view(v), projection(proj), camera(c), file_paths( {"../assets/Ocean/Albedo.jpeg", "../assets/Ocean/AO.jpg", "../assets/Ocean/Normal.jpg", "../assets/Ocean/Roughness.jpg", "../assets/Ocean/Displacement.jpg" } ), camera_front(front), fov(fv), number_ocean_patches(0), bar(b)
{
