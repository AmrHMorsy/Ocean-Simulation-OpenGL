#include "Boat.h"
#define NUMBER_OCEAN_PATCHES 100
...
public:
    ...
    Ocean( glm::mat4 view, glm::mat4 projection, glm::vec3 c, glm::vec3 front, float fv, progressbar * b, glm::mat4 light_proj, glm::mat4 _light_view) ;
