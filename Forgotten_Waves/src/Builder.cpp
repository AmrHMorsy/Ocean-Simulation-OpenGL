...
{
    window = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, "Forgotten Waves", NULL, NULL);
...
{
    renderer->set(window,context, compute_FourierAmplitudes_Kernel, compute_inverse_Fourier_Transform, queue);
